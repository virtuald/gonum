...
//
// See https://json-ld.github.io/normalization/spec/index.html for details.
func URGNA2012(dst, src []*Statement) ([]*Statement, error) {
	// 1. https://json-ld.github.io/normalization/spec/index.html#algorithm
	u := &urna{
...
// https://json-ld.github.io/normalization/spec/index.html#algorithm.
...
// at https://json-ld.github.io/normalization/spec/index.html#algorithm-1.
...
// https://json-ld.github.io/normalization/spec/index.html#algorithm-1.
func replaceBlank(b, matching, label string) string {
	...
	if label != "" { // URGNA2012 modification.
		...
		// "_:g", instead of "_:z".
		// https://json-ld.github.io/normalization/spec/index.html#urgna2012
		return label
	}
	// 3.1.1.1
	if b == matching {
...
// at https://json-ld.github.io/normalization/spec/index.html#hash-n-degree-quads.
...
// hashToRelatedURDNA2015 is the section 1., 2. and 3. of 4.8.2 of the spec
// at https://json-ld.github.io/normalization/spec/index.html#hash-n-degree-quads
// for URGNA2012 https://json-ld.github.io/normalization/spec/index.html#urgna2012.
...
// https://json-ld.github.io/normalization/spec/index.html#hash-related-blank-node.
